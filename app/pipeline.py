...
class RankingPipeline:
    ...
    def rank(
        ...
        *,
        ...
        # Sandbox uploads (≤100 rows): rank all eligible IDs in the file (§10.5 small sample).
        # Full candidates.jsonl: global hybrid recall (portal / team_sarva_automata.csv path).
